// @ts-nocheck — generated by stellar-cli against a different tsconfig; vendored verbatim.
// Generated TypeScript bindings for the passkey-kit smart-wallet contract.
// Source: kalepail/passkey-kit packages/passkey-kit-sdk/src/index.ts (MIT).
// Vendored unmodified for the testnet harness; regenerate with stellar-cli
// (stellar contract bindings typescript) against the same wasm.
...
import type { Option, u32 } from '@stellar/stellar-sdk/minimal/contract'
...
export type Signer =
  | { tag: 'Policy'; values: readonly [string, SignerExpiration, SignerLimits, SignerStorage] }
  | { tag: 'Ed25519'; values: readonly [Buffer, SignerExpiration, SignerLimits, SignerStorage] }
  | {
      tag: 'Secp256r1'
...
export type SignerVal =
  ...
  | { tag: 'Secp256r1'; values: readonly [Buffer, SignerExpiration, SignerLimits] }
